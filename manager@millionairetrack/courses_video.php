<?php
require 'sidebar.php';
$queryDirectIncomes= "SELECT * FROM `course-video`";
                    ...
                    <table class="table mb-0" id = "mytable">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom">Course ID</th>
                                <!-- <th class="border-bottom"></th> -->
                                <th class="border-bottom">Video Name</th>
                                <th class="border-bottom">Video Title</th>
