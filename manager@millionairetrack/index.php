    ...
    <body>
        ...
        <section class="cover-user bg-white">
            <div class="container-fluid px-0">
                ...
                <div class="col-lg-7 padding-less img order-1" style="background-image:url('assets/images/user/login1.png')" data-jarallax='{"speed": 0.5}'></div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <p class="forgot-pass mb-0"><a href="reset-password-cover.html" class="text-dark fw-bold">Forgot password ?</a></p>
                                                        </div>
                                                    </div><!--end col-->
