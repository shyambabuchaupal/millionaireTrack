<?php
require 'sidebar.php';
$queryDirectIncomes= "SELECT * FROM package";
                    ...
                    <table class="table mb-0" id = "mytable">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom">Package Code</th>
                                <th class="border-bottom">Package Name</th>
                                <th class="border-bottom">Package Price</th>
                                <th class="border-bottom">Discount Price</th>
                                <th class="border-bottom">Direct</th>
                                <th class="border-bottom">Passive</th>
                            ...
                            $c = 0;
                               foreach($details as $data){
                                $c++;
                                   ...
                                   echo '<td>'.$data['Package_price'].'</td>';
                                   echo '<td>'.$data['Direct'].'</td>';
                                   echo '<td>'.$data['passive'].'</td>';
