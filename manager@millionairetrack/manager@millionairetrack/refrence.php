                ...
                <div class="tab-pane fade show active" id="days7" role="tabpanel" aria-labelledby="all-tab">
                    <div class="table-responsive bg-white shadow rounded p-3">
                        <table id="employee_grid" class="table mb-0">
                            <thead>
                                <tr>
                                    <th class="border-bottom">Refrence ID</th>
                                    <th class="border-bottom">User ID</th>
                                    <th class="border-bottom">Refer ID</th>
                                    <th class="border-bottom">Transfer Date</th>
                                    <th class="border-bottom">Refrence Ammount</th>
                                    <th class="border-bottom">Level From</th>
                                    <th class="border-bottom">Payment Stetus</th>
                                </tr>
                            </thead>
                        </table>
                    </div>   
...
$('#employee_grid').DataTable({
         ...
         "serverSide": true,
         "ajax":{
            url :"response/response.php", // json datasource
