    ...
    <div class="col mt-4">
        <a href="#!" class="features feature-primary d-flex justify-content-between align-items-center bg-white rounded shadow p-3">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-1 ms-3">
                    <h6 class="mb-0 text-muted">Course Completed</h6>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow border-0 rounded">
                    <div class="d-flex align-items-center">
                        <img src="assets/images/course (1).jpeg" class="img-fluid avatar avatar-md-md rounded shadow" alt="">
                        <h6 class="mb-0 ms-3">Facebook Adds</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-4 col-lg-5 mt-4 rounded">
        <div class="card shadow border-0">
            <div class="p-4 border-bottom row">
                ...
                <div class="col-md-8">
                    <img src="assets/images/gold-package.png" width="100%" />
                </div>
            </div>
            <div class="d-flex justify-content-center m-3">
            <a href="javascript:void(0)" class="btn btn-outline-primary col-md-6">Start Learning</a>
            </div>
        </div>
    </div>
    <!--end col-->
